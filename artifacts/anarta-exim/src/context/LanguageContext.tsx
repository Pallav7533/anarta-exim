...
const translations = {
  en: {
    nav: { home: "Home", products: "Products", about: "About", contact: "Contact", getQuote: "Get a Quote", metals: "Metals & Industrial", spices: "Spices", jewellery: "Jewellery" },
    hero: { badge: "Serving Global Clients", headline1: "CONNECTING INDIA", headline2: "TO THE WORLD", sub: "Leading exporter of premium metal products, spices, and jewellery for global markets. Delivering precision, quality, and reliability across borders.", exploreProducts: "Explore Products", getQuote: "Get a Quote" },
    ...
    products: { title: "Our Expertise", heading: "Premium Export Categories", sub: "We source, process, and export top-tier materials across three major categories. Built for international standards, delivered with precision.", metalsTitle: "Metals & Industrial", metalsDesc: "High-strength hex bolts, screws, washers, and PEB structures for construction.", spicesTitle: "Spices Export", spicesDesc: "Vibrant, pure Indian spices including turmeric, chilli, cumin, and cardamom.", jewelleryTitle: "Jewellery Export", jewelleryDesc: "Elegant designs, high craftsmanship, export-quality pieces for international markets." },
    ...
    jewellery: { badge: "Imitation Jewellery", heading: "Elegant Fashion Jewellery", sub: "Premium export-quality artificial jewellery for international wholesale & retail markets.", craft: "Craftsmanship Meets Global Demand", partner: "Partner With Us", partnerSub: "We accommodate bulk orders and custom manufacturing requirements for international buyers of fashion jewellery." },
  },
  ar: {
  ...
  fr: {
    ...
    jewellery: { badge: "Bijoux artificiels", heading: "Bijoux de mode élégants", sub: "Bijoux artificiels de qualité exportation pour les marchés internationaux de gros et de détail.", craft: "L'artisanat répond à la demande mondiale", partner: "Partenariat avec nous", partnerSub: "Nous acceptons les commandes en gros et les exigences de fabrication personnalisées pour les acheteurs internationaux de bijoux de mode." },
  },
  es: {
    ...
    jewellery: { badge: "Joyería artificial", heading: "Joyería de moda elegante", sub: "Joyería artificial de calidad exportación premium para mercados internacionales de mayoreo y minoreo.", craft: "La artesanía responde a la demanda mundial", partner: "Asóciese con nosotros", partnerSub: "Aceptamos pedidos al por mayor y requisitos de fabricación personalizados para compradores internacionales de joyería de moda." },
  }
};
